...
const LandingPage = ({ handleLogin }: LandingPageProps) => {
  return (
    <div className="min-h-screen">
      <section className="bg-gradient-to-br from-brand-primary to-brand-900 text-white py-24 px-8 text-center">
        <h1 className="text-6xl font-extrabold mb-4 drop-shadow-md tracking-tight text-brand-50 shadow-brand">Echoherence</h1>
        ...
        <button 
          onClick={handleLogin}
          className="inline-block bg-white text-brand-primary px-8 py-4 rounded-lg font-semibold transition transform hover:-translate-y-0.5"
        >
          Start Collaborating
        </button>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
          <div className="bg-white p-8 rounded-xl shadow-sm">
            <h3 className="text-brand-primary text-xl font-semibold mb-4">Seamless Collaboration</h3>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            <h3 className="text-brand-primary text-xl font-semibold mb-4">Version Control</h3>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            <h3 className="text-brand-primary text-xl font-semibold mb-4">Advanced Audio Player</h3>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            <h3 className="text-brand-primary text-xl font-semibold mb-4">Interactive Comments</h3>
            <p className="text-gray-700">
